  ...
  return (
    <main className="w-full min-h-screen text-[var(--color-primary)] mx-auto">
      ...
      <section id="gallery" className="w-full h-screen md:p-0 py-20 relative flex items-center justify-center flex-col md:px-40">
        ...
        <p className="md:max-w-3xl max-w-full text-lg   font-worksans text-center z-10">Retrouvez dans notre galerie une sélection d&apos;articles pratiques et illustrés, conçus par nos experts serruriers. Découvrez nos conseils pentru renforcer la sécurité de votre logement, choisir les serrures adaptées à vos besoins, et savoir comment réagir rapidement en cas d&apos;urgence. Des contenus simples et utiles pentru vous accompagner au quotidien.</p>
      </section>
      {/* Testimoniale  */}
      <section id="avis" className="w-full h-screen relative flex items-center justify-start flex-col md:px-40">
        ...
        <p className="md:max-w-2xl max-w-full text-lg font-worksans text-center z-10">Découvrez les témoignages authentiques de nos clients satisfaits à Paris et dans toute l&apos;Île-de-France. Réactivité, professionnalisme et interventions sans dégât — nos serruriers sont recommandés pentru...</p>
